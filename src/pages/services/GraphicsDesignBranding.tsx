      ...
      <section id="roadmap-brand" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-fuchsia-400 dark:via-fuchsia-700 to-transparent -translate-x-1/2" />

...
const services = [
  ...
  { icon: Smartphone, title: "Mobile Apps", description: "Native and cross-platform mobile applications for iOS and Android using React Native and Flutter", features: ["Cross-Platform", "Native Performance", "App Store Ready", "Push Notifications"] },
  { icon: Cloud, title: "Cloud Solutions", description: "Scalable cloud infrastructure and deployment solutions using AWS, Azure, and Google Cloud", features: ["Auto Scaling", "High Availability", "Cost Optimized", "Security First"] },
  { icon: Database, title: "Backend Development", description: "Robust server-side applications with secure APIs, databases, and microservices architecture", features: ["RESTful APIs", "Database Design", "Microservices", "Security Focused"] },
  { icon: ShoppingCart, title: "E-commerce Solutions", description: "Complete online store solutions with payment integration, inventory management, and analytics", features: ["Payment Gateway", "Inventory System", "Order Management", "Analytics Dashboard"] },
  { icon: Cpu, title: "AI & Machine Learning", description: "Automate workflows and gain intelligent insights with integrated AI agents and machine learning.", features: ["Conversational AI", "Process Automation", "Predictive Analytics", "Real-Time Decision Making"] },
  { icon: Palette, title: "Graphics Design & Branding", description: "Crafting high-impact visual identities and premium UI/UX designs that elevate your brand's digital presence.", features: ["Logo & Brand Identity", "UI/UX Visual Design", "Motion Graphics", "Marketing Collaterals"] },
  { icon: PenTool, title: "Content Writing & Strategy", description: "Creating persuasive, SEO-optimized narratives that engage audiences and drive meaningful business growth.", features: ["SEO Content Writing", "Technical Copywriting", "Brand Storytelling", "Social Media Strategy"] },
  { icon: Palette, title: "UI/UX Design", description: "User-centered design solutions that create engaging and intuitive digital experiences", features: ["User Research", "Wireframing", "Prototyping", "Design Systems"] },
];

const ServiceCard = ({ service, index, inView }) => {
  const cardRef = useRef(null);
  const navigate = useNavigate();
  const Icon = service.icon; // Standard way to render dynamic icons
    ...
    <section ref={ref} className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        ...
        <div className="text-center mt-20">
          <Button
            size="lg"
            className="h-14 px-10 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 hover:bg-rose-600 dark:hover:bg-red-600 hover:text-white transition-all duration-300 rounded-2xl font-black text-lg shadow-xl shadow-rose-600/20 dark:shadow-red-600/30 uppercase tracking-widest"
            onClick={() => navigate("/contact")}
          >
